...
//:D it was missing an closing parenthesis and it had an unnessaceray extra curly brace the if statement wasn't placed in the function so it would never execute 
}
